...
class ConfigureRecordProtectionResponse(BaseModel):
    """
    The response format for configuring record protection.
    """ # noqa: E501
    protected_records: Optional[List[ProtectedRecordItem]] = Field(
        default=None,
        description=
        "List of records with their protection levels and protection status.")
    zone_id: Optional[StrictStr] = Field(
        default=None, description="The resource identifier.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["protected_records", "zone_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in protected_records (list)
        _items = []
        if self.protected_records:
            for _item in self.protected_records:
                if _item:
                    _items.append(_item.to_dict())
            _dict['protected_records'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "protected_records": [
                ProtectedRecordItem.from_dict(_item)
                for _item in obj["protected_records"]
            ] if obj.get("protected_records") is not None else None,
            "zone_id":
            obj.get("zone_id")
        })
