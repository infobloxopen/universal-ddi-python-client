...
class ProtectedRecordItem(BaseModel):
    """
    ...
    level: Optional[StrictStr] = Field(
        default=None,
        description=
        "The protection level (e.g., \"Global Admin\", \"DDI Admin\", \"None\")."
    )
    rname: Optional[StrictStr] = Field(
        default=None, description="The record name (relative to zone).")
    rtype: Optional[StrictStr] = Field(default=None,
                                       description="The record type.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["level", "rname", "rtype"]
