...
class PDPHealthCheck(BaseModel):
    """
    ...
    comment: Optional[StrictStr] = Field(
        default=None, description="Optional. Comment for __PDPHealthCheck__.")
    ...
    name: StrictStr = Field(description="Display name of __PDPHealthCheck__.")
    ...
    tags: Optional[Dict[str, Any]] = Field(
        default=None,
        description="Optional. The tags for __PDPHealthCheck__ in JSON format."
    )
