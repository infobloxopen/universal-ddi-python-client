...
class Pool(BaseModel):
    ...
    consolidated_health_enabled: Optional[StrictBool] = Field(
        default=None,
        description=
    ...
    __properties: ClassVar[List[str]] = [
        "comment", "consolidated_health_enabled", "disabled", "health_checks",
        "id", "inheritance_sources", "metadata", "method", "name",
        "pool_availability", "pool_servers_quorum", "server_availability",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comment":
            obj.get("comment"),
            "consolidated_health_enabled":
            obj.get("consolidated_health_enabled"),
            "disabled":
            obj.get("disabled"),
            "health_checks": [
