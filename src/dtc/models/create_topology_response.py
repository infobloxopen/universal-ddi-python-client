...
class CreateTopologyResponse(BaseModel):
    """
    The __Topology__ object create response format.
    """ # noqa: E501
    result: Optional[Topology] = Field(
        default=None, description="The created __Topology__ object.")
