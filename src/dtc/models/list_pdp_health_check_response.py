...
class ListPDPHealthCheckResponse(BaseModel):
    """
    The __PDPHealthCheck__ object list response format.
    """ # noqa: E501
    results: Optional[List[PDPHealthCheck]] = Field(
        default=None, description="List of __PDPHealthCheck__ objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results":
            [PDPHealthCheck.from_dict(_item) for _item in obj["results"]]
