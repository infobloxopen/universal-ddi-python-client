...
class CreateSIPHealthCheckResponse(BaseModel):
    """
    The __SIPHealthCheck__ object create response format.
    """ # noqa: E501
    result: Optional[SIPHealthCheck] = Field(
        default=None, description="The created __SIPHealthCheck__ object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            SIPHealthCheck.from_dict(obj["result"])
