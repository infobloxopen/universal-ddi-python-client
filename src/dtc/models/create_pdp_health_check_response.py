...
class CreatePDPHealthCheckResponse(BaseModel):
    """
    The __PDPHealthCheck__ object create response format.
    """ # noqa: E501
    result: Optional[PDPHealthCheck] = Field(
        default=None, description="The created __PDPHealthCheck__ object.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result":
            PDPHealthCheck.from_dict(obj["result"])
