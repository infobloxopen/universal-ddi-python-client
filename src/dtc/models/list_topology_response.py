...
class ListTopologyResponse(BaseModel):
    """
    The __Topology__ object list response format.
    """

  # noqa: E501
    results: Optional[List[Topology]] = Field(
        default=None, description="List of __Topology__ objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [Topology.from_dict(_item) for _item in obj["results"]]
